...
public class ColorTemplate {
     ...
     */
    public static final int[] VITAMIN_A_COLOR = {
            util.tools.getVitaminColor("A")
    };

    public static final int MAIN_COLOR = Color.parseColor("#fe5a5a");//R.color.backgroundMainColor;
